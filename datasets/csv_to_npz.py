...
from mjlab.utils.lab_api.math import axis_angle_from_quat, quat_conjugate, quat_mul, quat_slerp
from mjlab.viewer.offscreen_renderer import OffscreenRenderer
from mjlab.viewer.viewer_config import ViewerConfig
from tqdm import tqdm

from whole_body_control.tasks.tracking.config.vita_boy.env_cfgs import vita_boy_flat_tracking_env_cfg
...
def main(
    ...
    scene = Scene(vita_boy_flat_tracking_env_cfg().scene, device=device)
    joint_names = [
    ...
    output_dir = "./datasets/motions/vita_boy"
